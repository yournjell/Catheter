"""autogenerated by genpy from sr_grasp_msgs/TriangulateActionFeedback.msg. Do not edit."""
import sys
...
class TriangulateActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "sr_grasp_msgs/TriangulateActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','sr_grasp_msgs/TriangulateFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TriangulateActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = sr_grasp_msgs.msg.TriangulateFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = sr_grasp_msgs.msg.TriangulateFeedback()

"""autogenerated by genpy from sr_grasp_msgs/AdjustGraspActionGoal.msg. Do not edit."""
import sys
...
class AdjustGraspActionGoal(genpy.Message):
  _md5sum = "25c18e38a078af9529c8fcd98cb0d0a1"
  _type = "sr_grasp_msgs/AdjustGraspActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','sr_grasp_msgs/AdjustGraspGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AdjustGraspActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = sr_grasp_msgs.msg.AdjustGraspGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = sr_grasp_msgs.msg.AdjustGraspGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.goal.objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.objects:

"""autogenerated by genpy from sr_grasp_msgs/GraspManualActionResult.msg. Do not edit."""
import sys
...
class GraspManualActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "sr_grasp_msgs/GraspManualActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','sr_grasp_msgs/GraspManualResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GraspManualActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = sr_grasp_msgs.msg.GraspManualResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = sr_grasp_msgs.msg.GraspManualResult()

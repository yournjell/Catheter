"""autogenerated by genpy from sr_grasp_msgs/GraspObjectActionFeedback.msg. Do not edit."""
import sys
...
class GraspObjectActionFeedback(genpy.Message):
  _md5sum = "86c2bc09964fc9edeaafc0b5f8f65085"
  _type = "sr_grasp_msgs/GraspObjectActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','sr_grasp_msgs/GraspObjectFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GraspObjectActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = sr_grasp_msgs.msg.GraspObjectFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = sr_grasp_msgs.msg.GraspObjectFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B2d.pack(_x.feedback.state, _x.feedback.quality, _x.feedback.distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.state, _x.feedback.quality, _x.feedback.distance,) = _struct_B2d.unpack(str[start:end])
      return self

"""autogenerated by genpy from sr_grasp_msgs/GraspActionResult.msg. Do not edit."""
import sys
...
class GraspActionResult(genpy.Message):
  ...
  _type = "sr_grasp_msgs/GraspActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','sr_grasp_msgs/GraspResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = sr_grasp_msgs.msg.GraspResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = sr_grasp_msgs.msg.GraspResult()

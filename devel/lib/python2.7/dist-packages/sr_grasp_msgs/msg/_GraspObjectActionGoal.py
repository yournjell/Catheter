"""autogenerated by genpy from sr_grasp_msgs/GraspObjectActionGoal.msg. Do not edit."""
import sys
...
class GraspObjectActionGoal(genpy.Message):
  _md5sum = "3a39eece5e10d7baa34a94bf5a4adec5"
  _type = "sr_grasp_msgs/GraspObjectActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','sr_grasp_msgs/GraspObjectGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GraspObjectActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = sr_grasp_msgs.msg.GraspObjectGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = sr_grasp_msgs.msg.GraspObjectGoal()

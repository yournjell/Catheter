"""autogenerated by genpy from sr_grasp_msgs/PlanGraspActionResult.msg. Do not edit."""
import sys
...
class PlanGraspActionResult(genpy.Message):
  ...
  _type = "sr_grasp_msgs/PlanGraspActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','sr_grasp_msgs/PlanGraspResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = sr_grasp_msgs.msg.PlanGraspResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = sr_grasp_msgs.msg.PlanGraspResult()

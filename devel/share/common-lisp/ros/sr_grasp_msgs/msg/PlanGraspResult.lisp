...
(cl:defmethod cl:initialize-instance :after ((m <PlanGraspResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlanGraspResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sr_grasp_msgs-msg:<PlanGraspResult> is deprecated: use sr_grasp_msgs-msg:PlanGraspResult instead.")))

(cl:ensure-generic-function 'grasps-val :lambda-list '(m))
(cl:defmethod grasps-val ((m <PlanGraspResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sr_grasp_msgs-msg:grasps-val is deprecated.  Use sr_grasp_msgs-msg:grasps instead.")
  (grasps m))

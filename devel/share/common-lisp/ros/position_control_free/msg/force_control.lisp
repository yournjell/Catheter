...
;//! \htmlinclude force_control.msg.html

(cl:defclass <force_control> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass force_control (<force_control>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <force_control>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'force_control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name position_control_free-msg:<force_control> is deprecated: use position_control_free-msg:force_control instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <force_control>))
...
(cl:defmethod tension1-val ((m <force_control>))
...
(cl:defmethod tension2-val ((m <force_control>))
...
(cl:defmethod tension3-val ((m <force_control>))
...
(cl:defmethod tension4-val ((m <force_control>))
  ...
  (tension4 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <force_control>) ostream)
  "Serializes a message object of type '<force_control>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <force_control>) istream)
  "Deserializes a message object of type '<force_control>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<force_control>)))
  "Returns string type for a message object of type '<force_control>"
  "position_control_free/force_control")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'force_control)))
  "Returns string type for a message object of type 'force_control"
  "position_control_free/force_control")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<force_control>)))
  "Returns md5sum for a message object of type '<force_control>"
  "ea2612eb28a51adb81061f0a39210bc4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'force_control)))
  "Returns md5sum for a message object of type 'force_control"
  "ea2612eb28a51adb81061f0a39210bc4")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<force_control>)))
  "Returns full string definition for message of type '<force_control>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'force_control)))
  "Returns full string definition for message of type 'force_control"
  (cl:format cl:nil "Header header~%float64 tension1~%float64 tension2~%float64 tension3~%float64 tension4~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <force_control>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <force_control>))
  "Converts a ROS message object to a list"
  (cl:list 'force_control

// Generated by gencpp from file sr_grasp_msgs/PlanGraspGoal.msg
// DO NOT EDIT!


#ifndef SR_GRASP_MSGS_MESSAGE_PLANGRASPGOAL_H
#define SR_GRASP_MSGS_MESSAGE_PLANGRASPGOAL_H
...
struct PlanGraspGoal_
{
  ...
  typedef boost::shared_ptr< ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator> const> ConstPtr;

}; // struct PlanGraspGoal_

typedef ::sr_grasp_msgs::PlanGraspGoal_<std::allocator<void> > PlanGraspGoal;

typedef boost::shared_ptr< ::sr_grasp_msgs::PlanGraspGoal > PlanGraspGoalPtr;
typedef boost::shared_ptr< ::sr_grasp_msgs::PlanGraspGoal const> PlanGraspGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb534d92b2db78731ULL;
  static const uint64_t static_value2 = 0xfd9d596759e73967ULL;
};

template<class ContainerAllocator>
struct DataType< ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "sr_grasp_msgs/PlanGraspGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sr_grasp_msgs::PlanGraspGoal_<ContainerAllocator>& v)
  {
    s << indent << "object: ";
    s << std::endl;
...
#endif // SR_GRASP_MSGS_MESSAGE_PLANGRASPGOAL_H

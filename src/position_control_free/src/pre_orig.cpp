...
for(int h = 0; h <27 ;h++){
  ...
  Target_point.pose.position.y  = -(((target_position_y[h])-410)/3.5)/10 ; 
...
check_y = 0;
	...
	if(mm_py>=0){
	   ...
	   dteny1 = (0.03*(target_y - mm_py))+tension_v1;
	
	if(dteny1 < 0){ dteny1 = 0.03;}

		dteny2 = 0.00;

	if((tension_v1 < 0.1)&&(dteny1 < 0.05)){
		dteny2 = 0.20;
		dteny1 = 0.00;		
		}
...
check_y = 0;
	...
	if(mm_py<=0){
	   ...
	   dteny2 = (0.03*(abs(target_y) - abs(mm_py) ))+tension_v2;

	if(dteny2 < 0){ dteny2 = 0.03;}

		dteny1 = 0.00;

	if((tension_v2 < 0.1)&&(dteny2 < 0.05)){
		dteny1 = 0.20;
		dteny2 = 0.00;		
		}
}
...
check_y = 0;
	...
	if(mm_pz>=0){
	   ...
	   dtenz1 = (0.03*(target_z - mm_pz))+tension_v3;
	
	if(dtenz1 < 0){ dtenz1 = 0.03;}

		dtenz2 = 0.00;

	if((tension_v3 < 0.1)&&(dtenz1 < 0.05)){
		dtenz2 = 0.20;
		dtenz1 = 0.00;		
		}
}
	...
	if(mm_pz<=0){
	   ...
	   dtenz2 = (0.03*(abs(target_z) - abs(mm_pz)))+tension_v4;
	
	if(dtenz2 < 0){ dtenz2 = 0.03;}

		dtenz1 = 0.00;

	if((tension_v4 < 0.1)&&(dtenz2 < 0.05)){
		dtenz1 = 0.20;
		dtenz2 = 0.00;		
		}
}

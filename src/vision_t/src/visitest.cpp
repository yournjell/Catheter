...
for(int h = 0; h <8;h++){
 ...
 Target_point.pose.position.x = Target_point.pose.position.x = (abs(640-(target_position_x[h]))/3.5)/10; //position_side_final[i][3] and position_side_final[i][
       if((abs(640-(target_position_x[h]))/3.5)/10<5/10)  {  Target_point.pose.position.x = (abs(target_position_x[h]-478)/4.0)/5; }    
  Target_point.pose.position.y =  Target_point.pose.position.y =  -(((target_position_y[h])-416)/4.0)/10 ; 
  Target_point.pose.position.z =  Target_point.pose.position.z = -(((target_position_z[h]-282))/3.5)/10;//((position_side_final[i][2]/4.08)-(457/4.08))*0.1;

...
Target_point.color.a = 1.0;
  ...
  Target_point.pose.position.y  = -(((target_position_y[h])-416)/4.0)/10 ; 
  Target_point.pose.position.z  = -(((target_position_z[h]-282))/3.5)/10;//((position_side_final[i][2]/4.08)-(457/4.08))*0.1;
...
//Target_point.color.r = 0.0;
//Target_point.color.a = 1.0;
//Target_point.id =14+5;

 //Target_point.pose.position.x = Target_point.pose.position.x = (abs(640-(target_position_x[14]))/3.5)/10; //position_side_final[i][3] and position_side_final[i][
 //     if((abs(640-(target_position_x[14]))/3.5)/10<5/10)  {  Target_point.pose.position.x = (abs(target_position_x[14]-478)/4.0)/5; }    
 // Target_point.pose.position.y =  Target_point.pose.position.y =  -(((target_position_y[14])-416)/4.0)/10 ; 
//  Target_point.pose.position.z =  Target_point.pose.position.z = -(((target_position_z[14]-282))/3.5)/10;//((position_side_final[i][2]/4.08)-(457/4.08))*0.1;
...
circle(A2, center_s, 10, Scalar(255,255,0), 3, 8, 0);
	...
	points.id = i;
       ...
       p.x = (abs(640-(position_side_final[i][1]))/3.5)/10; //position_side_final[i][3] and position_side_final[i][

 if(((abs(640-(position_side_final[i][1]))/3.5)/10 )<5/10)  {  p.x = (abs(position_side_final[i][3]-478)/4.0)/5; }
       p.y =  (-((position_side_final[i][0])-416)/4.0)/10;
       p.z = (-((position_side_final[i][2]-282))/3.5)/10;//((position_side_final[i][2]/4.08)-(457/4.08))*0.1;

if (hjh>100){

if(abs(p.x-prev_position[i][0])>3){

p.x = prev_position[i][0];

}
if(abs(p.y-prev_position[i][1])>3){

p.y = prev_position[i][1];

}
if(abs(p.z-prev_position[i][2])>3){
...
//cout <<" x :"<< abs((position_side_final[3][1]/1.17)-236/1.17)/10<<"y: "<<abs((position_side_final[i][0]/1.2)-478/1.2)/10<<"z :"<< abs((position_side_final[i][2]-632))/10<<endl;
